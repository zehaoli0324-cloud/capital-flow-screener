...
def screen_stage1(df: pd.DataFrame, hs300_chg: float,
    ...
    """
    if hs300_chg <= -2.0:
        mkt_mode, pct_lo, pct_hi, vol_thresh, score_pass = "弱市",  0.5, 9.5, 1.2, 3
    elif hs300_chg <= 0:
        mkt_mode, pct_lo, pct_hi, vol_thresh, score_pass = "震荡",  1.0, 9.5, 1.5, 3
    else:
        mkt_mode, pct_lo, pct_hi, vol_thresh, score_pass = "强市",  1.5, 9.5, 1.5, 4
